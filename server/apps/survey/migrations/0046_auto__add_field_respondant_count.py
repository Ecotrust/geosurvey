...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.count'
        db.add_column(u'survey_respondant', 'count',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.count'
        db.delete_column(u'survey_respondant', 'count')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'count': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f83b2274-d5c3-4c3e-9641-47b9e6ba75f9'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
