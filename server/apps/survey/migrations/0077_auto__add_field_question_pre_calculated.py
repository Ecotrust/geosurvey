...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.pre_calculated'
        db.add_column(u'survey_question', 'pre_calculated',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.pre_calculated'
        db.delete_column(u'survey_question', 'pre_calculated')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'07726f65-8c08-4b6c-a457-8349753e0027'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
