...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.rows'
        db.add_column(u'survey_option', 'rows',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.rows'
        db.delete_column(u'survey_option', 'rows')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'61354ea2-a1d8-49c2-bae1-ac9c64d89caa'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
