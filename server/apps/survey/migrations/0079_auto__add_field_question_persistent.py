...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.persistent'
        db.add_column(u'survey_question', 'persistent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.persistent'
        db.delete_column(u'survey_question', 'persistent')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4ab5dc9d-73e6-49f8-8f53-f1d4a9d39eed'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
