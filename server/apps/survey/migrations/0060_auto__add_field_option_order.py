...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_option', 'order',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_option', 'order')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2a10cf3e-2668-4a40-9584-1c9f48a6a54a'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
