...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Respondant.email'
        db.alter_column(u'survey_respondant', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Respondant.email'
        db.alter_column(u'survey_respondant', 'email', self.gf('django.db.models.fields.EmailField')(default=None, max_length=254))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 7, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1cbe04cb-f3bf-4b1c-8975-a958a468b303'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
