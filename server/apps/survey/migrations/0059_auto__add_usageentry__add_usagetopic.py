...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsageEntry'
        db.create_table(u'survey_usageentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.UsageTopic'])),
            ('respondant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Respondant'])),
            ('data', self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True)),
            ('ts', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 1, 0, 0))),
        ))
        db.send_create_signal(u'survey', ['UsageEntry'])

        # Adding model 'UsageTopic'
        db.create_table(u'survey_usagetopic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=254)),
        ))
        db.send_create_signal(u'survey', ['UsageTopic'])


    def backwards(self, orm):
        # Deleting model 'UsageEntry'
        db.delete_table(u'survey_usageentry')

        # Deleting model 'UsageTopic'
        db.delete_table(u'survey_usagetopic')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fe5336df-e218-4ca1-92e4-fe829578ed31'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
