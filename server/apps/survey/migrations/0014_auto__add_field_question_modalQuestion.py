...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.modalQuestion'
        db.add_column(u'survey_question', 'modalQuestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.modalQuestion'
        db.delete_column(u'survey_question', 'modalQuestion_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'11e3e9f8-6a75-47ed-a8b4-f4c197b0a8bb'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
