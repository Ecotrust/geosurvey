...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.answer_raw'
        db.add_column(u'survey_response', 'answer_raw',
                      self.gf('django.db.models.fields.TextField')(default='raw'),
                      keep_default=False)
        for response in orm.Response.objects.all():
            response.answer_raw = response.answer
            response.save()

    def backwards(self, orm):
        # Deleting field 'Response.answer_raw'
        db.delete_column(u'survey_response', 'answer_raw')
    ...
    models = {
        ...
        u'survey.respondant': {
            'Meta': {'ordering': "['-ts']", 'object_name': 'Respondant'},
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ac156925-6ca3-4e10-a737-4007916ec31d'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
