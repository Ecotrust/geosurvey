...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.attach_to_profile'
        db.add_column(u'survey_question', 'attach_to_profile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.attach_to_profile'
        db.delete_column(u'survey_question', 'attach_to_profile')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 17, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0fb67dd1-9974-4d92-937e-486e782f8b2e'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
