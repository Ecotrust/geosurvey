...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_option', 'required',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_option', 'required')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'da3dacb5-1a03-4b58-be6c-341d1bd47c47'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
