...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.states'
        db.add_column(u'survey_survey', 'states',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Page.states'
        db.delete_column(u'survey_page', 'states')


    def backwards(self, orm):
        # Deleting field 'Survey.states'
        db.delete_column(u'survey_survey', 'states')

        # Adding field 'Page.states'
        db.add_column(u'survey_page', 'states',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e1044104-941c-4868-b259-09cd2604f0c7'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
