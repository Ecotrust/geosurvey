...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for respondent in orm.Respondant.objects.all():
            respondent.save()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'10f03cc8-d697-4912-b87f-18a6baf35e29'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
