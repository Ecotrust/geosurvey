...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.skip_question'
        db.add_column(u'survey_question', 'skip_question',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.skip_question'
        db.delete_column(u'survey_question', 'skip_question_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bbf310ad-ba82-4db5-a10d-6977d1a3bef7'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
