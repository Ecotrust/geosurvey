...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.integer_min'
        db.add_column(u'survey_question', 'integer_min',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.integer_max'
        db.add_column(u'survey_question', 'integer_max',
                      self.gf('django.db.models.fields.IntegerField')(default=365, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.integer_min'
        db.delete_column(u'survey_question', 'integer_min')

        # Deleting field 'Question.integer_max'
        db.delete_column(u'survey_question', 'integer_max')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 8, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'48c54281-299f-4680-abe0-ece180a88159'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
