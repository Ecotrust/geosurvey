...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.anon'
        db.add_column(u'survey_survey', 'anon',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.anon'
        db.delete_column(u'survey_survey', 'anon')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c73dc034-9a15-4424-973a-422d86da2a05'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
