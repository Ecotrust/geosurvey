...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Block'
        db.create_table(u'survey_block', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('skip_question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'], null=True, blank=True)),
            ('skip_condition', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['Block'])

        # Adding M2M table for field blocks on 'Question'
        m2m_table_name = db.shorten_name(u'survey_question_blocks')
        ...
        db.create_unique(m2m_table_name, ['question_id', 'block_id'])


    def backwards(self, orm):
        # Deleting model 'Block'
        db.delete_table(u'survey_block')

        # Removing M2M table for field blocks on 'Question'
        db.delete_table(db.shorten_name(u'survey_question_blocks'))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 25, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'85802f34-69b4-49a1-b549-5db6a8eb024d'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
