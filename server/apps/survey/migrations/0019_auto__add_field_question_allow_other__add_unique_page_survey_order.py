...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.allow_other'
        db.add_column(u'survey_question', 'allow_other',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'Page', fields ['survey', 'order']
        db.create_unique(u'survey_page', ['survey_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'Page', fields ['survey', 'order']
        db.delete_unique(u'survey_page', ['survey_id', 'order'])

        # Deleting field 'Question.allow_other'
        db.delete_column(u'survey_question', 'allow_other')
    ...
    models = {
        ...
        u'survey.page': {
            'Meta': {'unique_together': "(('survey', 'order'),)", 'object_name': 'Page'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2b208c99-86a4-4898-ba12-85800eb5cd19'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
