...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.geojson'
        db.add_column(u'survey_question', 'geojson',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.geojson'
        db.delete_column(u'survey_question', 'geojson')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d1063ff3-c386-497e-a9df-bb2d291d96e7'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
