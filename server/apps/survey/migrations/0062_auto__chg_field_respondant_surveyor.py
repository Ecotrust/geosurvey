...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Respondant.surveyor'
        db.alter_column(u'survey_respondant', 'surveyor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Respondant.surveyor'
        db.alter_column(u'survey_respondant', 'surveyor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.UserProfile'], null=True))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bd5efd67-cbde-48c5-9efa-b4d23a0aedd4'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
