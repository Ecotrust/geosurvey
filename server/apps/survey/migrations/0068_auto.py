...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field questions on 'Page'
        m2m_table_name = db.shorten_name(u'survey_page_questions')
        ...
        db.create_unique(m2m_table_name, ['page_id', 'question_id'])


    def backwards(self, orm):
        # Removing M2M table for field questions on 'Page'
        db.delete_table(db.shorten_name(u'survey_page_questions'))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a1bdc4db-3882-4810-8a19-9a48bb8d2b72'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
