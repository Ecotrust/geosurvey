...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GridAnswer'
        db.create_table(u'survey_gridanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Response'])),
            ('row_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('row_label', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('col_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('col_label', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('answer_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('answer_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'survey', ['GridAnswer'])
    ...
    def backwards(self, orm):
        # Deleting model 'GridAnswer'
        db.delete_table(u'survey_gridanswer')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 13, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ea63bac1-7ff1-4590-a5df-aea22a4b4e0f'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
