...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.geojson'
        db.add_column(u'survey_location', 'geojson',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.geojson'
        db.delete_column(u'survey_location', 'geojson')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'db53bbdf-7c81-4af0-9b3c-4a06ce58ae6b'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
