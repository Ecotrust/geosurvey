...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.info'
        db.add_column(u'survey_question', 'info',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.info'
        db.delete_column(u'survey_question', 'info')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a5fc2ed1-7d5a-45a7-894e-e06eb2244781'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
