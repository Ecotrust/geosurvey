...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.min_zoom'
        db.add_column(u'survey_question', 'min_zoom',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.min_zoom'
        db.delete_column(u'survey_question', 'min_zoom')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'min_zoom': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'979387a1-d7ff-4b05-8254-bca5f37efc57'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
