...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_response', 'user',
        ...
        # Adding field 'Respondant.user'
        db.add_column(u'survey_respondant', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_response', 'user_id')
        ...
        # Deleting field 'Respondant.user'
        db.delete_column(u'survey_respondant', 'user_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'26f81f4b-e9e6-45c2-9adf-b22dfeffe80d'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
