...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_page', 'order',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_page', 'order')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ba5a369f-a502-4b6c-9e1f-15792110f75c'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
