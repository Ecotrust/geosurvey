...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.either_or'
        db.add_column(u'survey_option', 'either_or',
                      self.gf('django.db.models.fields.SlugField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.either_or'
        db.delete_column(u'survey_option', 'either_or')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 2, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd9e84ff-f797-44b9-8a46-edbc725ea840'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
