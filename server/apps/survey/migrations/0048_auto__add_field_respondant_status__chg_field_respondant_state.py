...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.status'
        db.add_column(u'survey_respondant', 'status',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Respondant.state'
        db.alter_column(u'survey_respondant', 'state', self.gf('django.db.models.fields.CharField')(max_length=240, null=True))

    def backwards(self, orm):
        # Deleting field 'Respondant.status'
        db.delete_column(u'survey_respondant', 'status')


        # Changing field 'Respondant.state'
        db.alter_column(u'survey_respondant', 'state', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b7bc1bf2-f257-4051-a19a-798ae4fd840e'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
