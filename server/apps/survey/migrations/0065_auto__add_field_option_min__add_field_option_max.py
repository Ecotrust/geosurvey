...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.max'
        db.add_column(u'survey_option', 'max',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.min'
        db.delete_column(u'survey_option', 'min')

        # Deleting field 'Option.max'
        db.delete_column(u'survey_option', 'max')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 19, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'337e0644-0d7c-4565-8027-a568e9f4481a'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
