...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_locationanswer', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Location'])),
        ))
        db.send_create_signal(u'survey', ['LocationAnswer'])

        # Deleting field 'Location.answer'
        db.delete_column(u'survey_location', 'answer')


    def backwards(self, orm):
        # Deleting model 'LocationAnswer'
        db.delete_table(u'survey_locationanswer')

        # Adding field 'Location.answer'
        db.add_column(u'survey_location', 'answer',
                      self.gf('django.db.models.fields.TextField')(default='removed'),
                      keep_default=False)
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a4c5678a-568d-44c2-acc1-f2139eee807f'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
