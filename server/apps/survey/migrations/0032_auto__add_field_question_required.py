...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_question', 'required',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_question', 'required')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9435bb40-1934-46e0-be5c-773d9079bec4'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
