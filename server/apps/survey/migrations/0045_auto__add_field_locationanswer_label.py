...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationAnswer.label'
        db.add_column(u'survey_locationanswer', 'label',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationAnswer.label'
        db.delete_column(u'survey_locationanswer', 'label')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'45f30973-d51e-425b-a6d6-8036160670fb'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
