...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'survey_response', 'respondant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Respondant'], null=True))

    def backwards(self, orm):

        # Changing field 'Response.respondant'
        db.alter_column(u'survey_response', 'respondant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['survey.Respondant']))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3cfbd295-a603-49c8-b7c4-8de9b24a3570'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
