...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.respondant'
        db.add_column(u'survey_location', 'respondant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Respondant'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Location.respondant'
        db.delete_column(u'survey_location', 'respondant_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5821e661-69cd-4ded-88d5-490350c63a43'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
