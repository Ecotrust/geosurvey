...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.term_condition'
        db.add_column(u'survey_question', 'term_condition',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.term_condition'
        db.delete_column(u'survey_question', 'term_condition')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1be149cd-76a7-48d9-a0f9-7e9b2d168581'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
