...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.report_type'
        db.add_column(u'survey_question', 'report_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Question.report_type'
        db.delete_column(u'survey_question', 'report_type')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 16, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e94af348-82b9-4d5d-b03e-4e729eeba7db'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
